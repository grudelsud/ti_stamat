...
class UploadHandler
{
    ...
    public function setPath($pathExtension) {
        $this->options['upload_dir'] = $this->options['upload_dir'] . $pathExtension . "/";
        $this->options['upload_url'] =  $this->options['upload_url'] . $pathExtension . "/";
        $this->options['image_versions']['thumbnail']['upload_dir']=$this->options['image_versions']['thumbnail']['upload_dir'] . $pathExtension . "/";
        $this->options['image_versions']['thumbnail']['upload_url']=$this->options['image_versions']['thumbnail']['upload_url'] . $pathExtension . "/";
    }
