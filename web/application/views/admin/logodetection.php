...
<div class="container">
   ...
   <form method="post" action="logo/upload" id="process_form">
    ...
    <?php if(count($results)>0){  ?> 
            <h4 id="processListString">Processing List</h4> 
        <?php }else{ ?>
    ...
    <table class="table table-striped" id="tableProcess">
        ...
        <?php  for ($i=0; $i< count($results); $i++) { ?>
            <tr id="idProcess<?php echo  $results[$i]['idProcess'] ?>">
            <td><?php echo  basename($results[$i]['logoUrl']) ?></td>
...
<script src="<?=base_url()?>application/public/js/logo/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="<?=base_url()?>application/public/js/logo/jquery.fileupload.js"></script>
<!-- The File Upload file processing plugin -->
<script src="<?=base_url()?>application/public/js/logo/jquery.fileupload-fp.js"></script>
<!-- The File Upload user interface plugin -->
<script src="<?=base_url()?>application/public/js/logo/jquery.fileupload-ui.js"></script>
